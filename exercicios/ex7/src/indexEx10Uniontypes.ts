...
type paymentMethod = "credito" | "pix" | "boleto"

function processPayment(pValue:number, pType:paymentMethod){
    if(pType == "credito"){
    ...
    else return "Boleto de R$" + pValue + " gerado. Aguardando compensação."
}
